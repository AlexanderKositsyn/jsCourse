...
filterInput.addEventListener("keyup", function(e) {
  ...
  //проверям есть ли элементы которые совпадают с введенным совом в инпут
  // и если совпадает то добавляем новый элемент в список вохможных
  townsPromise.forEach((item, index) => {
